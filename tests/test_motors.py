...
def main():
    ...
    try:
        ...
        print("  Expected: servo moves 0° → 20° → 0°.")
        servo_move(0,  "Motor 1 (theta)")
        time.sleep(PAUSE_S)
        servo_move(20, "Motor 1 (theta)")
        time.sleep(PAUSE_S)
        servo_move(0,  "Motor 1 (theta)")
        time.sleep(PAUSE_S)
        ...
        print("  Expected: servo moves to 20° while stepper moves forward.")
        t1 = threading.Thread(target=servo_move,   args=(20, "Motor 1 (theta)"))
